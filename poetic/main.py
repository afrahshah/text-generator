...
for i, satz in enumerate(sentences):
    ...
    y[i, char_to_index[next_char[i]]] = 1           #generate next character and gather sentences
    
    
#boolean array, 1 when char appears
...
#128neurons layer,resulta add upto1 gives porbabilty
